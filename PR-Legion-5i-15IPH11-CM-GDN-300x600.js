...
lib.ssMetadata = [
		{name:"PR_Legion_5i_15IPH11_CM_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_5i_15IPH11_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion5i15IPH11CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(180).to({_off:false},0).to({_off:true},60).wait(170));

	// Layer_3
	this.instance_4 = new lib.Frame3();
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(120).to({_off:false},0).to({_off:true},60).wait(230));
...
// library properties:
lib.properties = {
	id: '9025E52EE22CD24A8807B4BA566D8A41',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_5i_15IPH11_CM_GDN_300x600_atlas_1.png", id:"PR_Legion_5i_15IPH11_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['9025E52EE22CD24A8807B4BA566D8A41'] = {
